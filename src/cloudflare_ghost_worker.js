...
async function handleRequest(request) {
	...
	newResponse.headers.set(
		...
		"\
            ...
            img-src 'self' *.vsassets.io ghost.org *.supabase.co *.spacergif.org *.unsplash.com *.tenor.com *.gravatar.com *.ghost.org *.cloudgenius.app cloudgenius.app thecloudseminar.com *.thecloudseminar.com *.amazonaws.com *.ytimg.com *.vimeocdn.com *.githubusercontent.com blob: data:; \
